                      ...
                      >
                        ...
                        >
                          <Image
                            ...
                            priority={true}
                            className={
                              'hover:image-yellow-500 transition-colors'
                            }
                            width={200}
                            height={200}
                            placeholder="blur"
                          ...
                          <div className="flex justify-center">
                            <button
                              className="rounded-full bg-blue-500 p-2 text-white no-underline hover:bg-blue-700 hover:shadow-xl"
                              onClick={() => {}}
                            >
                              Saiba mais
                            </button>
...
export default loadTransitions(CV)
